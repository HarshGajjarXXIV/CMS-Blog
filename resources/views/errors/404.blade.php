...
<body class="permission_denied">
  ...
  <h1>404</h1>
  <h3>LOST IN SPACE? Hmm, looks like something went wrong.</h3>
<a href="{{ route('home') }}"><button class="denied__link">Go Home</button></a>  <svg id="astronaut" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    <style>
